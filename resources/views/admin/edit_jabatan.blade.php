    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('jabatan.update', $jabatan->id) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_jabatan" id="nama" value="{{ old('nama', $jabatan->nama_jabatan) }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi"
                    class="block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows="4" placeholder="Masukkan deskripsi">{{ old('deskripsi', $jabatan->deskripsi) }}</textarea>
            </div>
            <button type="submit"
