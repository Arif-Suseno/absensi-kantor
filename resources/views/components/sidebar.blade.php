    ...
    <ul
        ...
        @if (Auth::check() && auth()->user()->role === 'Admin')
            ...
            <x-navlink href="/manajemen_absensi" :active="request()->is('manajemen_absensi')"><i class="fas fa-calendar-check px-2"></i>Manajemen
                Absensi</x-navlink>
            <x-navlink href="/data_karyawan" :active="request()->is('data_karyawan')"><i class="fa-solid fa-users px-2"></i>Data
                Karyawan</x-navlink>
            ...
            <x-navlink href="/kontrak" :active="request()->is('kontrak')"><i class="fa-solid fa-file-contract px-2"></i>
                Kontrak</x-navlink>
            <x-navlink href="/persetujuan_izin&cuti" :active="request()->is('persetujuan_izin&cuti')"><i class="fa-solid fa-envelope px-2"></i>
                Persetujuan
                Izin & Cuti</x-navlink>
